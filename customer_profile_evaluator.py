...
TrainModel = PythonVirtualenvOperator(
    ...
    requirements=['sendgrid==6.4.8','apache-airflow','psycopg2-binary','google-cloud-bigquery','google-cloud-bigquery-storage','pandas','pyarrow','datetime','pandas_gbq','tqdm','google-cloud-storage','sklearn'],
    python_version='3',
    trigger_rule='all_done',
    dag=dag
)
PredictProfile = PythonVirtualenvOperator(
    ...
    requirements=['sendgrid==6.4.8','apache-airflow','psycopg2-binary','google-cloud-bigquery','google-cloud-bigquery-storage','pandas','pyarrow','datetime','pandas_gbq','tqdm','google-cloud-storage','fsspec', 'sklearn','gcsfs'],
    python_version='3',
    trigger_rule='all_done',
    dag=dag
)
